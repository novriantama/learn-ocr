    ...
    <link rel="stylesheet" href="{{ URL::asset('/dist/css/jquery.selectareas.css') }}">
    ...
    <script src="{{ URL::asset('/dist/js/stisla.js') }}"></script>
    <script src="{{ URL::asset('/dist/js/scripts.js') }}"></script>
    <script src="{{ URL::asset('/dist/js/custom.js') }}"></script>
    <script src="{{ URL::asset('/dist/js/jquery.selectareas.js') }}"></script>
